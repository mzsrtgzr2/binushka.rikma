...
- לאחר התשלום, שלחי לי בוואטספ את שם הילד.ה ו3 שדות שתרצי שיופיעו על התעודה מתוך הבאים - משקל, תאריך, שעת לידה, מקום לידה, מזל או פריט מידע אחר שחשבת עליו.
- ֿ אכין לך עיצוב ואשלח לך אותו לאישור סופי.
