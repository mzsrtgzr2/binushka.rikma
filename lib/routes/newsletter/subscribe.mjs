import { emailCopy } from '../../newsletter/email-copy.mjs';
import { createRateLimiter, readClientIp, readJsonBody, sendJson } from '../../http.mjs';
...
import { siteUrl, unsubscribeUrl } from '../../newsletter/urls.mjs';
