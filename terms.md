  ...
  <div class="terms-content">
    ...
    <section class="terms-section">
      ...
      <ul>
        ...
        <li>קיום סדנה מותנה בהרשמת מינימום 5 משתתפות</li>
        <li>מספר המשתתפות יכול להשתנות לפי שיקול דעתה של נותנת השירות, אך לא יעלה על 10 משתתפות</li>
        <li>בעבור מפגש שלא מומש יינתן זיכוי של 30% מסכום מפגש למימוש בסדנאות או מוצרים שאני מציעה. מפגש הוא סכום העסקה חלקי מספר המפגשים</li>
